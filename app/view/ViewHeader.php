    ...
    public static function getHTMLHeader($title)
    {
        $html = '
            ...
            <head>
              ...
              <link rel="shortcut icon" type="image/x-icon" href="App/view/assets/favicon.ico" />
              ...
              <script src="app/view/assets/js/menuActive.js"></script>
              <script>
                requirejs.config({
                  baseUrl: "."
                });
              ...
              <div class="page">
                <div class="page-main">
                      ...
                      <div class="row align-items-center">
                        ...
                        <div class="col-lg order-lg-first">
                          <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                            <li class="nav-item">
                                <a id="home-link" href="/" class="nav-link"><i class="fe fe-home"></i> Home</a>
                            </li>
                            <li class="nav-item">
                                <a id="produtos-link" href="/produtos" class="nav-link"><i class="fe fe-package"></i> Produtos</a>
                            </li>
                            <li class="nav-item">
                                <a id="venda-link" href="/venda" class="nav-link"><i class="fe fe-dollar-sign"></i> Venda</a>
                            </li>
                            <li class="nav-item">
                                <a id="lixeira-link" href="/excluidos" class="nav-link"><i class="fe fe-trash"></i> Lixeira</a>
                            </li>
                          </ul>
                        </div>
                      </div>
                  ...
                  <script>
                    ...
                    var vendaLink = document.getElementById("venda-link");
                    var lixeiraLink = document.getElementById("lixeira-link");
                    ...
                    if (path === "/") {
                      ...
                      vendaLink.classList.add("active");
                    } else if (path === "/excluidos") {
                      lixeiraLink.classList.add("active");
                    }
                  </script>';
